...
`tdr_forca`,`tdr_destreza`, `tdr_constituicao`, `tdr_inteligencia`, `tdr_sabedoria`, `tdr_carisma`,`percp_passiva`, `bonus_profici`,
`deslocamento`,`iniciativa`,`classe_armadura`,`inspiracao`,`vida_maxima`, `vida_atual`, `per_acrobacia`, `per_arcanismo`, `per_atletismo`, 
`per_atuacao`, `per_blefar`, `per_furtividade`,`per_historia`, `per_intimidacao`, `per_investigacao`, `per_lidar_animais`, `per_medicina`, 
`per_natureza`,`per_persuasao`, `per_prestidigitacao`,`per_religiao`,`per_sobrevivencia`,`armor`, `armas`, `ferramentas`, `linguagens`)
 VALUES('$codJogador', '$nome_jogador' , '$nome_personagem', '$raca_personagem', '$nivel_personagem','$classe_personagem',
    ...
    '$tdr_constituicao','$tdr_inteligencia', '$tdr_sabedoria', '$tdr_carisma', '$percp_passiva',
    '$bonus_profici', '$deslocamento', '$iniciativa', '$classe_armadura','$inspiracao', '$vida_maxima','$vida_atual',
    '$per_acrobacia', '$per_arcanismo', '$per_atletismo', '$per_atuacao', '$per_blefar', '$per_furtividade','$per_historia', '$per_intimidacao', 
    '$per_investigacao','$per_lidar_animais', '$per_medicina', '$per_natureza', '$per_persuasao', 
