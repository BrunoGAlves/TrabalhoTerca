...
<body>
    ...
    <div class="primary-nav">
        ...
        <nav role="navigation" class="menu">
            <a href="#" class="logotype"><span>PERSONAGENS</span></a>
            <div class="overflow-container">
                <ul class="menu-dropdown">
                    ...
                    <li
                        style="color: #e0dfdf; text-align: center; position: absolute; bottom: 15px; background-color: rgb(190, 68, 68); width: 250px;">
                            <button id="formularioShow"> +Novo Personagem </button>
                        <span
                            style="position: absolute; bottom: 12px; left: 170px;" class="icon"><i
                                class="fa-solid fa-circle-plus"></i></span></li>
                </ul>
            </div>
        </nav>
    </div>
                        ...
                        <div class="form_segundario" id="form_segundario">
                                    ...
                                    <div class="fields">     
                                        <div class="input-field-salva">
                                            <ul class="lista-salva">
                                                <li><input type="number" class="salvaguarda" placeholder="Força" required> Força</li>
                                                <li><input type="number" class="salvaguarda" placeholder="Destreza" required> Destreza</li>
                                                <li><input type="number" class="salvaguarda" placeholder="Constituição" required> Constituição</li>
                                                <li><input type="number" class="salvaguarda" placeholder="Inteligência" required> Inteligência</li>
                                                <li><input type="number" class="salvaguarda" placeholder="Sabedoria" required> Sabedoria</li>
                                                <li><input type="number" class="salvaguarda" placeholder="Carisma" required> Carisma </li>
                                            </ul>
                                        </div> 
                                    </div>
                                </div>
                            ...
                            <div class="detalhes pericias">
                                ...
                                <div class="fields">     
                                    <div class="input-field-salva">
                                        <ul class="lista-salva">
                                            <li><input type="number" class="salvaguarda" placeholder="Força" required> Acrobacia </li>
                                            <li><input type="number" class="salvaguarda" placeholder="Destreza" required> Arcanismo </li>
                                            <li><input type="number" class="salvaguarda" placeholder="Constituição" required> Atletismo</li>
                                            <li><input type="number" class="salvaguarda" placeholder="Força" required> Atuação </li>
                                            <li><input type="number" class="salvaguarda" placeholder="Destreza" required> Enganação </li>
                                            <li><input type="number" class="salvaguarda" placeholder="Constituição" required> Furtividade</li>
                                            <li><input type="number" class="salvaguarda" placeholder="Força" required> Historia </li>
                                            <li><input type="number" class="salvaguarda" placeholder="Destreza" required> Intimidação  </li>
                                        </ul>
                                    </div>        
                                    <div class="input-field-salva">
                                        <ul class="lista-salva">
                                        <li><input type="number" class="salvaguarda" placeholder="Constituição" required> intuição </li>
                                        <li><input type="number" class="salvaguarda" placeholder="Força" required> investigação  </li>
                                        <li><input type="number" class="salvaguarda" placeholder="Destreza" required> Lidar com animais </li>
                                        <li><input type="number" class="salvaguarda" placeholder="Constituição" required> Medicina</li>
                                        <li><input type="number" class="salvaguarda" placeholder="Destreza" required> Natureza  </li>
                                        <li><input type="number" class="salvaguarda" placeholder="Constituição" required> Percepção </li>
                                        <li><input type="number" class="salvaguarda" placeholder="Força" required> Prestigitação  </li>
                                        <li><input type="number" class="salvaguarda" placeholder="Destreza" required> Religião </li>
                                        <li><input type="number" class="salvaguarda" placeholder="Constituição" required> Sobrevivencia </li>
                                        </ul>
                                    </div> 
                                </div>
                            </div>
                                ...
                                <div class="detalhe pessoal">
                                    ...
                                    <div class="fields">     
                                        <div class="input-field">
                                            ...
                                            <input type="number" class="mod-combate" placeholder="Digite o valor da classe:" required>
                                        </div>
            
                                        <div class="input-field">
                                            <label for="Nome">Iniciativa: </label>
                                            <input type="number" class="mod-combate" placeholder="Digite o valor de iniciativa:" required>
                                        </div>
